...
class BattleResultsVictoryViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let enemy1Image = enemy1.drawCharacter(view: self.view, x: 10, y: 500, width: 100, height:120, isInvisible: false)
        
        // enemy 2
        let enemy2 = characterSprites(name: "Rogue")
        let enemy2Image = enemy2.drawCharacter(view: self.view, x: 100, y: 500, width: 100, height: 120, isInvisible: false)
        
        // enemy 3
        let enemy3 = characterSprites(name: "Fighter")
        let enemy3Image =  enemy3.drawCharacter(view: self.view, x: 200, y: 500, width: 100, height: 120, isInvisible: false)
        
        // enemy  4
        let enemy4 = characterSprites(name: "Wizard")
        let enemy4Image = enemy4.drawCharacter(view: self.view, x: 290, y: 500, width: 100, height: 120, isInvisible: false)
