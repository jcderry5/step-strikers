...
class BattleResultsLossViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let player1Image = player1.drawCharacter(view: self.view, x: 10, y: 550, width: 100, height:100, isInvisible: false)
        
        // player 2
        let player2 = characterSprites(name:  "Skeleton")
        let player2Image = player2.drawCharacter(view: self.view, x: 100, y: 550, width: 100, height: 100, isInvisible: false)
        
        // player 3
        let player3 = characterSprites(name:  "Skeleton")
        let player3Image =  player3.drawCharacter(view: self.view, x: 200, y: 550, width: 100, height: 100, isInvisible: false)
        
        // player  4
        let player4 = characterSprites(name:  "Skeleton")
        let player4Image = player4.drawCharacter(view: self.view, x: 290, y: 550, width: 100, height: 100, isInvisible: false)
