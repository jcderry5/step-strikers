...
final class MessageLogUnitTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        playerThree = Rogue(characterName: "Inigo Montoya", userName: "amazingAlekhya", health: 30, stamina: 30, currWeapon: fistsForPlayerThree, weaponsInInventory: [fistsForPlayerThree], currArmor: noArmorForPlayerThree, armorInInventory: [noArmorForPlayerThree], itemsInInventory: [], inventoryQuantities: [:])
...
////        // Act
////        playerOne.actionSurge(rollValue: 20)
////
////        //Assert
////        let expectedMessageLog = ["\(playerOne.characterName) has action surged to do double damage against \(currTarget.name)"]
////        XCTAssertTrue(expectedMessageLog == messageLog.getMessageLog())
////    }
//
...
//    }
//
//    // TODO: @Alekhya add tests for insight and allsight message log
